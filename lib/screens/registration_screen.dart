  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        validator: (value) {
          ...
          if (value!.isEmpty) {
            return ("Ingresar Primer Nombre");
          }
          if (!regex.hasMatch(value)) {
            return ("Ingresar Nombre Valido(Min. 3 Caracteres)");
          }
          return null;
        },
        onSaved: (value) {
    ...
    final secondNameField = TextFormField(
        ...
        validator: (value) {
          if (value!.isEmpty) {
            return ("Ingresar Segundo Nombre");
          }
          return null;
        },
        onSaved: (value) {
    ...
    final passwordField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Ingresar Contraseña Valida(Min. 6 Caracteres)");
          }
        },
        onSaved: (value) {
          firstNameEditingController.text = value!;
  ...
  void signUp(String email, String password) async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        switch (error.code) {
          case "invalid-email":
            errorMessage = "Ingresar Correo Valido.";
            break;
          case "wrong-password":
          ...
          case "too-many-requests":
            errorMessage = "Muchas Solicitudes, Espere.";
            break;
          case "operation-not-allowed":
            errorMessage = "Correo O Constraseña No Son Habiles.";
            break;
          default:
